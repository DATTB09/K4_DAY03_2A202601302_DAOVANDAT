...
1. analyze_cv[cv_text, job_description]: Phân tích mức độ phù hợp của CV với mô tả công việc.
...
3. schedule_interview[candidate_name, preferred_time, interviewer]: Tạo lịch phỏng vấn mô phỏng.
...
TIMEOUT_SECONDS = 20  # Timeout tối đa cho mỗi lượt gọi công cụ / nhận phản hồi
GEMINI_REQUEST_DELAY_SECONDS = 13  # Free Tier giới hạn thấp; tránh gửi dồn nhiều request.
